...
public class ModifiedK2Report {
	...
	private boolean foundByTenable;
	...
	public boolean isFoundByTenable() {
		return foundByTenable;
	}

	public void setFoundByTenable(boolean foundByTenable) {
		this.foundByTenable = foundByTenable;
	}
	...
	public String toString() {
		return "K2 OutPut\n\nAttack Time : " + attackTime + "\nIP : " + iP + "\nAttack Description : " + attackDescription
				...
				+ ports + "\nHTTP URL : " + hTTPURL + "\nExecuted Query/Command : " + executedQueryOrCommand
